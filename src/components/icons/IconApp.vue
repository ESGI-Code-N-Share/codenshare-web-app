...
<template>
  <svg v-if="name === 'reset'" height="16" viewBox="0 0 32 32" width="16">
    <path d="M18 28A12 12 0 1 0 6 16v6.2l-3.6-3.6L1 20l6 6l6-6l-1.4-1.4L8 22.2V16a10 10 0 1 1 10 10Z"/>
  </svg>

  <svg v-if="name === 'update'" height="16" viewBox="0 0 24 24" width="16">
    <path
  ...
  <svg v-if="name === 'sun'" height="16" viewBox="0 0 24 24" width="16">
    <path
  ...
  <svg v-if="name === 'moon'" height="16" viewBox="0 0 24 24" width="16">
    <path
  ...
  <svg v-if="name === 'save'" height="14" viewBox="0 0 448 512" width="12.25" xmlns="http://www.w3.org/2000/svg">
