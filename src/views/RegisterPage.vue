...
async function onSubmitRegisterForm() {
    try {
        ...
        toastNotifications.showSuccess(t(`auth.user-count-created`));

    } catch (e: ValidatorHandleError | Error | any) {
...
<template>
    <AuthPage>
        <div class="flex w-full h-full surface-card border-round-3xl p-4 m-autor">
            <div
                class="flex flex-column gap-5 justify-content-center col-12 md:col-6 xl:col-5 p-1 sm:p-8 md:p-5 lg:p-6">
                <div class="md:mb-4">
                    ...
                    <form ref="registerFormRef" class="flex flex-column gap-3">
                        ...
                        <div class="flex align-items-center">
                            ...
                            <label class="text-sm" for="cgu">
                                ...
                                <a class="text-blue-500 no-underline font-medium cursor-pointer">conditions
                                    d'utilisation</a>
                            </label>
                        </div>
